// const packageRename = require('../package.json')
// const config = require('./cli.js')
// .program({name: packageRename.name.replace(/@.+\//, ''), version: packageRename.version})
...
// .parse(process.argv)
export default function run(portConfig, forceHostConfig) {
	const config = {
		port: portConfig,
		forceHost: forceHostConfig
	}
